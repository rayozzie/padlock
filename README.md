...
Except for this comment, Padlock was vibe-coded over the course of several days in early 2025 as a means of trying to understand the limits of the technique. For better or worse, this involved many hundreds of written instructions issued to multiple models over many hours, with corrections and rewrites.  As compared with what's now possible with modern CLI-based tooling, he process was needlessly painful because of the inability for the default UI's to natively integrate with my file system.  
